...
<head>
  ...
  <title><?= $this->rendersection('titleContent');?></title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo mr-auto"><img src="<?= base_url(); ?>/assets/img/logo.png" alt=""></a>-->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span><?= $this->rendersection("welcomeTitle"); ?></spa>
      </h1>	
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://www,interlinks.in/">VIP IT</a>
      </div>
    </div>
  </footer><!-- End Footer -->
